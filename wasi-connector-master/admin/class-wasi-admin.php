...
class Wasi_Connector_Admin {
	...
	public function register_api_settings() {
        ...
        add_settings_section('wasi_settings_wp',
            __('Configuración Propiedades', $this->context),
        ...
        add_settings_field(
            ...
            __('Propiedades por página', $this->context), // Title 
        ...
        add_settings_field(
            'wp_page', // ID
            __('Página de propiedades', $this->context), // Title 
        ...
        add_settings_field(
            'wp_single_page', // ID
            __('Pagina de propiedades individuales', 'wasico'), // Title 
        ...
        add_settings_field(
            ...
            __('Duración de la Cache', $this->context), // Title 
    ...
    public function render_wp_settings_info() {
        echo __('Son importantes para el correcto funcionamiento del plugin', 'wasico');
    }

	public function render_api_settings_info() {
		echo sprintf(__('Conecta tus propiedades de <a href="http://wasi.co/" target="_blank">wasi.co</a> directamente en tu sitio web a través de tu información API. Conoce dónde buscarla aquí: %s)<br /><br />
            En caso de requerir asistencia adicional y/o personalizada, nuestro equipo de desarrollo te puede ayudar.<br />
            Para contactarlos, dale clic al siguiente enlace: <a href="https://givemeservicesas.com/contacto-medellin" target="_blank">givemeservicesas.com/contacto-medellin</a>', 'wasico'), '<a href="https://api.wasi.co/" target="_blank">https://api.wasi.co/</a>');
	}
    ...
    public function render_select_page($field) {
        ...
        echo '<br /> <small>';
        echo __('Asegúrese de poner el shortcode [wasi-properties] en el contenido de esa página', 'wasico');
        echo '</small>';
    }
    ...
    public function render_select_single_page($field) {
        ...
        wp_dropdown_pages($args);
        echo '<br /> <small>';
        echo __('El contenido de esta página cambiará dinámicamente según cada propiedad', 'wasico');
        echo '</small>';
    }
    ...
    public function render_checkbox_bootstrap($field) {
        ...
        echo '<label><input class="wasi_input" type="checkbox" id="wasi_bootstrap" name="wasi_api_data[wasi_bootstrap]" value="load" '.$checked.' />'.__('Cargar Bootstrap 3', 'wasico').'</label>';
        echo '<br /> <small>';
        echo __('Si habilitó esta casilla de verificación, se cargará el Bootstrap 3 de la biblioteca UI.<br />Úselo solo si su tema no usa bootstrap.', 'wasico');
        echo '</small>';
    }


    public function render_clear_cache($field) {
        echo '<button id="wasi-clear-cache">'.__('Limpiar la Cache del plugin', 'wasico').'</button>';
        echo '<span id="clear-cache-results"></span>';
        echo '<br/><small>';
        echo __('Borre la caché interna de complementos si sus propiedades Wasi se han actualizado', 'wasico');
        echo '</small>';
    }
    public function render_cache_duration($field) {
        ...
        echo '<br /> <small>';
        echo __('Duración de la caché en días', 'wasico');
        echo '</small>';
    }
